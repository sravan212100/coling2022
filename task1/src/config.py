...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_path', type=str, default='../data/Task1a/train/train_data.tsv')
    parser.add_argument('--valid_path', type=str, default='../data/Task1a/valid/valid_data.tsv')
    parser.add_argument('--test_path', type=str, default='data/test_tweets_unannotated.tsv')
