...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_path', type=str, default='../data/task5_train_user_wlabel.tsv')
    parser.add_argument('--valid_path', type=str, default='../data/task5_validation_user_NOlabel.tsv')
    parser.add_argument('--test_path', type=str, default='data/task5_test_user_NOlabel.tsv')
