...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_path', type=str, default='../data/training_data.csv')
    parser.add_argument('--valid_path', type=str, default='../data/validation_data.csv')
    parser.add_argument('--test_path', type=str, default='data/testing_input.csv')
