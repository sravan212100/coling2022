...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_path', type=str, default='../data/df_train.csv')
    parser.add_argument('--valid_path', type=str, default='../data/df_val.csv')
    parser.add_argument('--test_path', type=str, default='data/df_test.csv')
