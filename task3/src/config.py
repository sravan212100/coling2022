...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_path', type=str, default='../data/MSC_Twitter_9835_011720_TRAIN.tsv')
    parser.add_argument('--valid_path', type=str, default='../data/MSC_Twitter_9835_011720_VAL.tsv')
    parser.add_argument('--test_path', type=str, default='data/Task3a_Twitter_TEST_With_Decoys.tsv')
    ...
    # =========================== 是否进行subtask b进行训练=========================
    parser.add_argument('--web', action='store_true', help='是否进行premise分类')
