...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_path', type=str, default='../data/SMM4H-2022-Task4-Training.tsv')
    parser.add_argument('--valid_path', type=str, default='../data/SMM4H-2022-Task4-Validation.tsv')
    parser.add_argument('--test_path', type=str, default='data/SMM4H-2022-Task4-Test-Unlabeled.tsv')
    ...
    # ===========================focal loss =========================
    parser.add_argument('--gamma_focal', type=float, default=0.3,help="大于0则表示使用focal loss")
